#! /bin/sh
# Last successfully run on April 1st, 2018
...
export CBIG_CODE_DIR=/data/users/xlkong/storage/CBIG_private
...
export CBIG_TESTDATA_DIR=N.A.
export CBIG_REPDATA_DIR=N.A.
...
#export MATLABPATH=/data/users/xlkong/matlab
