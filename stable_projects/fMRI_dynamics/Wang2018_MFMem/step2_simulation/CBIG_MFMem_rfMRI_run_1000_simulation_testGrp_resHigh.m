function CBIG_MFMem_rfMRI_run_1000_simulation_testGrp_resHigh(save_dir_input)

%--------------------------------------------------------------------------
% CBIG_MFMem_rfMRI_run_1000_simulation_testGrp_resHigh
%
% Input parameters:
...
save( [save_dir '/1000simulation_testGrp_resHigh_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3))],'CC_check');
rmpath(lib_dir);
