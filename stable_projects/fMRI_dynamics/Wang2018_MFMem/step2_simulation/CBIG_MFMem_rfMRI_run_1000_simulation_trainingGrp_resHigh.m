function CBIG_MFMem_rfMRI_run_1000_simulation_trainingGrp_resHigh(save_dir_input)

%--------------------------------------------------------------------------
% CBIG_MFMem_rfMRI_run_1000_simulation_trainingGrp_resHigh()
%
% Input parameters:
...
funcP = @(Para_E,Nstate) CBIG_MFMem_rfMRI_nsolver_eul_sto_resLH(Para_E,SC,y,FC_mask,Nstate,14.4,0.72,1);
...
save( [save_dir '/1000simulation_trainingGrp_resHigh_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3))],'CC_check');
rmpath(lib_dir);
end
