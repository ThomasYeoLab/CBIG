function CBIG_MFMem_rfMRI_run_1000_simulation_testGrp_resHigh_lau()

%--------------------------------------------------------------------------
% CBIG_mfm_rfMRI_run_1000_simulation_testGrp_resHigh
% 
...
save( [save_dir '/1000simulation_testGrp_resHigh_' num2str(saved_date(1)) num2str(saved_date(2)) ...
