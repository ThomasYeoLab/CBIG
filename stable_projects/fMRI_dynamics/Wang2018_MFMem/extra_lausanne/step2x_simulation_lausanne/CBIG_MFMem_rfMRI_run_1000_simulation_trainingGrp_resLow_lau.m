function CBIG_MFMem_rfMRI_run_1000_simulation_trainingGrp_resLow_lau()

%--------------------------------------------------------------------------
% CBIG_mfm_rfMRI_run_1000_simulation_trainingGrp_resLow
%
% This function is to run 1000 times simluation of FC, useing estimated parameter and
% SC of training grp, simulation running in low time resolution t = 0.01s
%
...
%% load FC, SC
FCSC_file_name = 'FCSC_Lausanne_Kong_Wang.mat';
...
funcP = @(Para_E,Nstate) CBIG_mfm_rfMRI_nsolver_eul_sto_resLH(Para_E,SC,y,FC_mask,Nstate,14.4,0.72,0);
...
save( [save_dir '/1000simulation_trainingGrp_resLow_' num2str(saved_date(1)) num2str(saved_date(2)) ...
