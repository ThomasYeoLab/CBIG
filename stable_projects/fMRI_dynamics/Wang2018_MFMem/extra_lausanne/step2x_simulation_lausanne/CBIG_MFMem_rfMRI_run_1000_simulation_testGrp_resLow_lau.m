function CBIG_MFMem_rfMRI_run_1000_simulation_testGrp_resLow_lau()
...
% SC of test grp, simulation running in low time resolution t = 0.01s
%
...
save( [save_dir '/1000simulation_testGrp_resLow_' num2str(saved_date(1)) num2str(saved_date(2)) ...
