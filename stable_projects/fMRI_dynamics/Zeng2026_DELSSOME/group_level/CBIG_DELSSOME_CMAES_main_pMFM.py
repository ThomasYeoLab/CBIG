...
import numpy as np
import os
from CBIG_DELSSOME_pMFM_optimizer import pMFM_Validator, pMFM_Tester, train_help_function
...
def optimize_body(mode,
    ...
    if mode == 'train':
        ...
        mfm_validator = pMFM_Validator(config, save_param_dir, val_dir)
        ...
        mfm_tester = pMFM_Tester(config, val_dirs, test_dir, trained_epochs=num_epochs)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser('pMFM settings')
    parser.add_argument(
        '--mode',
        type=str,
