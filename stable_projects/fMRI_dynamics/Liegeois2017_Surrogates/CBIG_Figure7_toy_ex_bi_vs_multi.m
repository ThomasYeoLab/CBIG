function CBIG_Figure7_toy_ex_bi_vs_multi

% CBIG_Figure7_toy_ex_bi_vs_multi
% 
...
x12=x([1 2],:);
[Y,B_12,Z,E]=CBIG_ar_mls(x12',1);
B_12(:,2:3)

%second permutation
x13=x([1 3],:);
[Y,B_13,Z,E]=CBIG_ar_mls(x13',1);
B_13(:,2:3)

%third permutation
x23=x([2 3],:);
[Y,B_23,Z,E]=CBIG_ar_mls(x23',1);
B_23(:,2:3)
