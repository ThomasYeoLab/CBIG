...
"clear;clc;close all;CBIG_pMFM_step2_STDFCD_permutation_correlation_desikan;exit;"

mv ../output/step2_compute_correlation \
../../../replication/part2_pMFM_control_analysis/STDFCD_permutation_Desikan/results/
