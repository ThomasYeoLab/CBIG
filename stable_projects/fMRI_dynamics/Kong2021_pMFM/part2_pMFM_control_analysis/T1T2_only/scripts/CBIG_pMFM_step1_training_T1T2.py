...
def CBIG_mfm_optimization_desikan_main(gpu_index=0, random_seed=1):
    ...
    start_point_w, template_mat = get_init(myelin_data, highest_order,
                                           init_para[0:n_node])
    start_point_i, template_mat = get_init(myelin_data, highest_order,
                                           init_para[n_node:n_node * 2])
    start_point_sigma, template_mat = get_init(myelin_data, highest_order,
