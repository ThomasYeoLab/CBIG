...
def CBIG_mfm_optimization_desikan_main(random_seed=1, gpu_index=0):
    ...
    output_path = '../output/rsfcpc2_T1T2/training/'
    ...
    gradient_pc1 = fc.csv_matrix_read(
        '../../../input/Desikan_input/myelin.csv')
    gradient_pc1 = gradient_pc1[:, 0]
    ...
    start_point_w, template_mat = get_init(gradient_pc1, gradient_pc2,
                                           highest_order, init_para[0:n_node])
    start_point_i, template_mat = get_init(gradient_pc1, gradient_pc2,
                                           highest_order,
                                           init_para[n_node:n_node * 2])
    start_point_sigma, template_mat = get_init(gradient_pc1, gradient_pc2,
                                               highest_order,
