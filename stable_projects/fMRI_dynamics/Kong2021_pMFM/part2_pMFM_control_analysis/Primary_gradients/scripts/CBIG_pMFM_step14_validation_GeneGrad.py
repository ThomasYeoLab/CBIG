...
def CBIG_mfm_validation_desikan_main(gpu_index=0):
    ...
    input_path = '../output/gene_rsfc/training/'
    output_path = '../output/gene_rsfc/validation/'
    ...
    myelin_data = sio.loadmat(
        '../../../input/Desikan_input/gene_gradient1.mat')
    myelin_data = myelin_data['gene_pc1']
...
if __name__ == '__main__':
    CBIG_mfm_validation_desikan_main(gpu_index=3)
