function CBIG_pMFM_step8_gene_expression_analysis_schaefer()

% This function is the wrapper to perform all the genetic analysis for
...
w_para = para_first(1:100);
I_para = para_first(101:200);
s_para = para_first(202:end);
...
BT_num = 1000;
BT_correlation_empirical = zeros(BT_num, 100);
for bt = 1:BT_num
    BT_corr_Emp = [];
        for i = 1:num_4run
...
BT_num = 1000;
BT_correlation_simulated = zeros(BT_num, 100);
rng(1)
