function CBIG_pMFM_step1_generate_permutation_order_schaefer()
...
load('../../Schaefer100_parcellation/output/step5_STDFCD_results/STD_FCD_simulated_rundata.mat','FCD_sim_allrun')
