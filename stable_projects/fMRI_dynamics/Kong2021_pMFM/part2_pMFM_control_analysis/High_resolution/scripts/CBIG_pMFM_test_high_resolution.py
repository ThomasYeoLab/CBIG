...
def CBIG_mfm_test_desikan_main_highres(gpu_index=0):
    '''
    This function is to compute the fc correlation and fcd KS statistics for
    top 10 selected model parameters based on 0.001 time step during BOLD
    signal generation
    ...
    for j in range(0, 10):
        ...
        for k in range(int(1000 / n_set)):
            ...
            total_cost, fc_cost, fcd_cost = fc.CBIG_combined_cost_test_highres(
                arx, n_dup)
...
if __name__ == '__main__':
    ...
    CBIG_mfm_test_desikan_main_highres()
