...
def CBIG_mfm_validation_desikan_main(gpu_index=0, weight=0.5):
    '''
    ...
    input_path = '../output/SpGrad_SpT1T2/weight_' + str(weight) + '/training'
    output_path = '../output/SpGrad_SpT1T2/weight_' + str(
        weight) + '/validation'
    ...
    myelin_data = fc.csv_matrix_read(
        '../../../input/Desikan_input/myelin_spinned.csv')
    myelin_data = myelin_data[:, 0]
    gradient_data = fc.csv_matrix_read(
        '../../../input/Desikan_input/rsfc_gradient_spinned.csv')
...
if __name__ == '__main__':
    CBIG_mfm_validation_desikan_main(gpu_index=0, weight=0.5)
