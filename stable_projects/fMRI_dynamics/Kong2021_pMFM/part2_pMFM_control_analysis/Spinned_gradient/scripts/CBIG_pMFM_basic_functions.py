...
def CBIG_combined_cost_train(parameter, n_dup, weight):
    '''
    ...
    total_cost = weight * fc_cost + (2 - weight) * fcd_cost

    return total_cost, fc_cost, fcd_cost


def CBIG_combined_cost_validation(parameter, n_dup, weight):
    '''
    This function is implemented to calcualted the FC correlation and
    FCD KS
