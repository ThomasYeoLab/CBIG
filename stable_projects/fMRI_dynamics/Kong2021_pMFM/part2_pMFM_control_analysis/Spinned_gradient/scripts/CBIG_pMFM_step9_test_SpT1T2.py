...
def CBIG_mfm_test_desikan_main(gpu_index=0, weight=0.5):
    ...
    input_path = '../output/SpT1T2/weight_' + str(weight) + '/validation'
    output_path = '../output/SpT1T2/weight_' + str(weight) + '/test'
...
if __name__ == '__main__':
    CBIG_mfm_test_desikan_main(gpu_index=0, weight=0.5)
