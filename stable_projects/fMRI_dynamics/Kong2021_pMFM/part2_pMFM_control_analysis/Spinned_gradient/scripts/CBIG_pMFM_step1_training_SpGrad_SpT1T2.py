...
def CBIG_mfm_optimization_desikan_main(random_seed=1, gpu_index=0, weight=0.5):
    '''
    ...
    output_path = '../output/SpGrad_SpT1T2/weight_' + str(weight) + '/training'
...
if __name__ == "__main__":
    CBIG_mfm_optimization_desikan_main(random_seed=1, gpu_index=0, weight=0.5)
