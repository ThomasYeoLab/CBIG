function CBIG_pMFM_step2_STDFCD_permutation_correlation_desikan()
...
null_mat = zeros(68,perm_time);

for i = 1:perm_time
    perm_index = perm_result_all(:,:,i);
    corr_perm = zeros(68,sub_num);
    for j = 1:68
...
null_test_all = zeros(68,100*(length(null_test_file)-2));

load('../../../part1_pMFM_main/output/step5_STDFCD_results/STD_FCD_empirical.mat','SWSTD_FCD_emp')
...
load('../../../part1_pMFM_main/output/step5_STDFCD_results/STD_FCD_simulated.mat','SWSTD_FCD_sim')
