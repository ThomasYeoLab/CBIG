...
def CBIG_mfm_test_desikan_main(gpu_index=0, subject=1):
    ...
    subject_path = '../../../input/Desikan_input/individual_input/subject' + str(
        subject) + '/'
    input_path = '../output/subject' + str(subject) + '/gradient/validation/'
    output_path = '../output/subject' + str(subject) + '/gradient/test/'
...
if __name__ == '__main__':
    CBIG_mfm_test_desikan_main(subject=1, gpu_index=0)
