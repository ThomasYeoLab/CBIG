...
def CBIG_mfm_validation_desikan_main(gpu_index=0, weight=1):
    ...
    input_path = '../output/weight_' + str(weight) + '/T1T2/training/'
    output_path = '../output/weight_' + str(weight) + '/T1T2/validation/'
...
if __name__ == '__main__':
    CBIG_mfm_validation_desikan_main(gpu_index=0, weight=1)
