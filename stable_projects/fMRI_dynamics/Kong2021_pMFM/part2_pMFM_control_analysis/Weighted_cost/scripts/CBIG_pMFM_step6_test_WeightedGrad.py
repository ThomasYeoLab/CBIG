...
def CBIG_mfm_test_desikan_main(gpu_index=0, weight=1):
    '''
    ...
    input_path = '../output/weight_' + str(weight) + '/gradient/validation/'
    output_path = '../output/weight_' + str(weight) + '/gradient/test/'
...
if __name__ == '__main__':
    CBIG_mfm_test_desikan_main(gpu_index=0, weight=1)
