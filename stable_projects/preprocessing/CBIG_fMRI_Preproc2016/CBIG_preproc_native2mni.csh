...
foreach runfolder ($bold)
	...
	parallel -j 16 CBIG_helper_preproc_native2mni_project1mm.csh {} $frame_dir $anat_s $anat_dir $MNI_ref_id \
	...
	parallel -j 16 CBIG_helper_preproc_native2mni_downsample2mm.csh {} $frame_dir $MNI_ref_id $temp_2mm $LF \
		::: `seq 0 $nframes_dec`
	# set fcount = 0;
