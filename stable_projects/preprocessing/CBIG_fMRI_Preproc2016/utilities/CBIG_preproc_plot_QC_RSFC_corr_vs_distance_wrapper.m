function CBIG_preproc_plot_QC_RSFC_corr_vs_distance_wrapper( sub_dir, sub_list, ...
    QC_type, RSFC_stem, output_name, distance_file )
...
%       fullfile(getenv('CBIG_CODE_DIR'), 'stable_projects', 'preprocessing', 'CBIG_fMRI_Preproc2016', ...
%       'data', 'ROIs2ROIs_VolAnatDistance', ...
%       'ROIs2ROIs_distance_Schaefer2018_400Parcels_17Networks_order_19aseg_FSLMNI152_1mm.mat')
% 
% Example:
%     CBIG_preproc_plot_QC_RSFC_corr_vs_distance_wrapper( ...
% fullfile(getenv('CBIG_preproc_REP_GSP_DIR'), 'CBIG_preproc_global_cen_bp', 'GSP_single_session', ...
% 'CBIG2016_preproc_global_cen_bp')), fullfile(getenv('CBIG_preproc_REP_GSP_DIR'), ...
% 'CBIG_preproc_global_cen_bp', 'GSP_single_session', 'scripts', 'surf_exist_list.txt'), ...
% 'FD_mean', '_rest_skip4_stc_mc_residc_interp_FDRMS0.2_DVARS50_bp_0.009_0.08_fs6_sm6_all2all', ...
% fullfile(getenv('HOME'), 'storage', 'PreprocessingPipeline', 'QC_plots_2', 'data', ...
% 'QC-RSFC_distance_plot', 'plots', 'GSP', 'GSP_single_session', 'CBIG2016_global_cen_bp') )
% 
% 
...
if(~exist('distance_file', 'var'))
    distance_file = fullfile(getenv('CBIG_CODE_DIR'), 'stable_projects', 'preprocessing', ...
        'CBIG_fMRI_Preproc2016', 'data', 'ROIs2ROIs_VolAnatDistance', ...
