function CBIG_LiGSR_LRR_replication_cmp_w_reference_HCP( final_result )

% CBIG_LiGSR_LRR_replication_cmp_w_reference_HCP( final_result )
% 
% This function compares the unit test results generated using
% CBIG_LiGSR_LRR_replication_cmp2pipe_HCP against the ground truth results
...
%     CBIG_LiGSR_LRR_replication_cmp2pipe_HCP.m
%     It should contain three 20x59 matrices: 
%     acc_GSR_mean: the mean accuracy of each random split of 59 behavioral
%                   and demographic measures with global signal regression.
%     acc_Baseline_mean: the mean accuracy of each random split of 59
