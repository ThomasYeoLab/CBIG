...
test_dir=/mnt/eql/yeo1/CBIG_private_unit_tests_data/stable_projects/preprocessing/Li2019_GSR/replication/KernelRidgeRegression/GSP
...
for pipeline in GSR Baseline ; do
	...
	for seed in $(seq 1 1 20); do
		...
		echo $cmd | qsub -V -q circ-spool -l walltime=04:00:00,mem=6GB -m ae -N CBIG_LiGSR_KRR_replication_all_GSP
