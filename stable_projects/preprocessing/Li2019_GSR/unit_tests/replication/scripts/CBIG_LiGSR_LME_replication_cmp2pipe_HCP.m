function CBIG_LiGSR_LME_replication_cmp2pipe_HCP( LME_dir )

% CBIG_LiGSR_LME_replication_cmp2pipe_HCP( LME_dir )
% 
% This function integrate the output files of
% CBIG_LiGSR_LME_replication_all_HCP.sh and compare the results of Baseline
% and Baseline+GSR pipelines.
% 
% Inputs:
%   - LME_dir
%     The output directory of CBIG_LiGSR_LME_replication_all_HCP.sh. It is
...
CBIG_LiGSR_LME_cmp2pipe_allstats( fullfile(getenv('CBIG_CODE_DIR'), ...
    'stable_projects', 'preprocessing', 'Li2019_GSR', 'unit_tests', 'replication', ...
    'scripts', 'HCP_lists', '58behaviors_age_sex.txt'), ...
