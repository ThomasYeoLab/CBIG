function CBIG_LiGSR_KRR_replication_cmp2pipe_HCP( KRR_dir )

% CBIG_LiGSR_KRR_replication_cmp2pipe_HCP( KRR_dir )
% 
% This is step 2 of the replication unit test using the HCP dataset.
% 
% This function integrate the output files of
% CBIG_LiGSR_KRR_replication_all_HCP.sh and compare the results between
% Baseline and Baseline_GSR pipelines.
% 
% Inputs:
%   - KRR_dir
%     The output directory of CBIG_LiGSR_KRR_replication_all_HCP.sh. It is
...
stem = {'13cognitive', '22personality', '23emotion', 'Age', 'Sex'};
