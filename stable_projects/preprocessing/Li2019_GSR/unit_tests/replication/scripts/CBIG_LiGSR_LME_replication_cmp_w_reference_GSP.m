function CBIG_LiGSR_LME_replication_cmp_w_reference_GSP( all_stats_mat )

% CBIG_LiGSR_LME_replication_cmp_w_reference_GSP( all_stats_mat )
% 
% This function compares the variance component model results of GSP
...
%     CBIG_LiGSR_LME_replication_cmp2pipe_GSP.m
% 
% Written by Jingwei Li and CBIG under MIT license: https://github.com/ThomasYeoLab/CBIG/blob/master/LICENSE.md

ref_dir = '/mnt/eql/yeo1/CBIG_private_unit_tests_data/stable_projects/preprocessing/Li2019_GSR';
ref_result = fullfile(ref_dir, 'replication', 'VarianceComponentModel', 'GSP', ...
