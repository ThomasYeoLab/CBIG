function CBIG_LiGSR_LRR_unittest_PMAT_cmp_w_reference_HCP( final_result )
...
% CBIG_LiGSR_LRR_PMAT_cmp2pipe_HCP and compares it against the ground truth
% results to determine if all the related linear ridge regression function
% are working accurately.
% 
% Inputs:
%   - final_result
%     The full path of a .mat file. This file is the output of
%     CBIG_LiGSR_LRR_PMAT_cmp2pipe_HCP.m
%     It should contain three 3x1 vectors: 
