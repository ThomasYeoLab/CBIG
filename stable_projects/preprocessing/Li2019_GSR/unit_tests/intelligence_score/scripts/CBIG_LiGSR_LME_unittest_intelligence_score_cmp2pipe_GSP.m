function CBIG_LiGSR_LME_unittest_intelligence_score_cmp2pipe_GSP( LME_dir )

% CBIG_LiGSR_LME_unittest_intelligence_score_cmp2pipe_GSP( LME_dir )
% 
% This function integrate the output files of
% CBIG_LiGSR_LME_unittest_intelligence_score_GSP.sh and compare the results
% of Baseline and Baseline+GSR pipelines.
% 
% Inputs:
%   - LME_dir
...
CBIG_LiGSR_LME_cmp2pipe_allstats( fullfile(getenv('CBIG_CODE_DIR'), 'stable_projects', 'preprocessing', ...
    'Li2019_GSR', 'unit_tests', 'intelligence_score', 'scripts', 'GSP_lists', 'intelligence_score.txt'), ...
    fullfile(LME_dir, 'GSR'), fullfile(LME_dir, 'Baseline'), 862, 5, 431, ...
