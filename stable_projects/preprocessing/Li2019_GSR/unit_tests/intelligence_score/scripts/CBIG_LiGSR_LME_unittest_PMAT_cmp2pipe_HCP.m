function CBIG_LiGSR_LME_unittest_PMAT_cmp2pipe_HCP( LME_dir )

% CBIG_LiGSR_LME_unittest_PMAT_cmp2pipe_HCP( LME_dir )
% 
% This function integrate the output files of
% CBIG_LiGSR_LME_unittest_PMAT_HCP.sh and compare the results of Baseline
% and Baseline+GSR pipelines.
% 
% Inputs:
%   - LME_dir
%     The output directory of CBIG_LiGSR_LME_unittest_PMAT_HCP.sh. It is
...
CBIG_LiGSR_LME_cmp2pipe_allstats( fullfile(getenv('CBIG_CODE_DIR'), 'stable_projects', 'preprocessing', ...
    'Li2019_GSR', 'unit_tests', 'intelligence_score', 'scripts', 'HCP_lists', 'PMAT24.txt'), ...
    fullfile(LME_dir, 'GSR'), fullfile(LME_dir, 'Baseline'), 419, 1000, 209, ...
