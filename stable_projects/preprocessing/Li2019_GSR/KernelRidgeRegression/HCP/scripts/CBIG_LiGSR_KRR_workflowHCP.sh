...
matlab -nodesktop -nosplash -nodisplay -r " addpath $root_dir; CBIG_LiGSR_KRR_workflowHCP( \
   ...
   '$DVARS_file', '$outdir', '$outstem', '$num_test_folds', '$num_inner_folds', '$seed', '$with_bias' ); exit; " \
   >> $LF 2>&1
...
REQUIRED ARGUMENTS:
	...
	-y_list            y_list           : A text list of target measures to be predicted (e.g. behaviors). Each line 
	                                      ...
	                                      headers in either restricted_csv or unrestricted_csv.
	-covariate_list    covariate_list   : A text list of covariate names (e.g. age, sex, FD) that need to be regressed 
	                                      ...
	                                      covariate name. Except for FD and DVARS, the covariate name stated in this 
	                                      list should correspond to one of the headers in either restricted_csv or 
	                                      unrestricted_csv.
