...
Usage: $0 -g <GMToAffineTmpList> -o <outDir>
    - GMToAffineTmpList     Text file with each line being the path to a GMToAffineTmp image; 
                            e.g., ~/outputs/VBM/nonlinRegToAffineTmp/GMToAffineTmpList.txt
...
# re-average
fslmaths ${outDir}GMToAffineTmp_4d_mean -add ${outDir}GMToAffineTmp_4d_mean_flipped -div 2 ${outDir}nonlinTmp 
