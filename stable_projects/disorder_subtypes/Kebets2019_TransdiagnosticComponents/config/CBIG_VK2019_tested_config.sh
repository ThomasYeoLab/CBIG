#! /bin/sh
# Last successfully run on July 8th, 2019
...
export CBIG_CODE_DIR=/data/users/vkebets/storage/CBIG_private
...
export CBIG_VK2019_UCLA_CNP_DIR=/mnt/eql/yeo9/data/UCLAconsortiumNeuropsych
