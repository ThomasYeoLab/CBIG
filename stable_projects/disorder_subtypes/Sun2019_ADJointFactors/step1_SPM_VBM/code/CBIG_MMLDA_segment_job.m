%-----------------------------------------------------------------------
% Job saved on 22-Apr-2016 17:56:02 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6470)
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.sanlm = 1;
matlabbatch{1}.spm.tools.cat.estwrite.extopts.NCstr = 0.75;
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.darteltpm = '<UNDEFINED>';
matlabbatch{1}.spm.tools.cat.estwrite.extopts.restypes.best = [1 0.1];
