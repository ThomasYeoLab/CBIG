...
- To download the version of the code that was last tested, you can either
  ...
  - visit this link:
  [https://github.com/ThomasYeoLab/CBIG/releases/tag/v0.12.0-Yeo2015_AuthorTopic](https://github.com/ThomasYeoLab/CBIG/releases/tag/v0.12.0-Yeo2015_AuthorTopic)
  ...
  ```
  git checkout -b Yeo2015_AuthorTopic v0.12.0-Yeo2015_AuthorTopic
  ```
