...
# submission
cmd_prefix="bash $ROOTDIR/replication/scripts/CBIG_DeepResBat_replica_step8_eval_glm.sh "$1

# unharm
cmd=$cmd_prefix" unharm"
job_name=$job_prefix"_Step8_"$1"_unharm"
...
job_name=$job_prefix"_Step8_"$1"_ComBat4cov"
$CBIG_CODE_DIR/setup/CBIG_pbsubmit -cmd "$cmd" \
    -name $job_name \
    -walltime 04:00:00 \
    -mem 4G \
...
job_name=$job_prefix"_Step8_"$1"_CovBat4cov"
$CBIG_CODE_DIR/setup/CBIG_pbsubmit -cmd "$cmd" \
    -name $job_name \
    -walltime 04:00:00 \
    -mem 4G \
...
# cVAE
cmd=$cmd_prefix" cVAE"
job_name=$job_prefix"_Step8_"$1"_cVAE"
$CBIG_CODE_DIR/setup/CBIG_pbsubmit -cmd "$cmd" \
    -name $job_name \
    -walltime 04:00:00 \
    -mem 4G \
...
job_name=$job_prefix"_Step8_"$1"_coVAE"
$CBIG_CODE_DIR/setup/CBIG_pbsubmit -cmd "$cmd" \
    -name $job_name \
    -walltime 04:00:00 \
    -mem 4G \
...
job_name=$job_prefix"_Step8_"$1"_DeepResBat"
$CBIG_CODE_DIR/setup/CBIG_pbsubmit -cmd "$cmd" \
    -name $job_name \
    -walltime 04:00:00 \
    -mem 4G \
