function [labels, colortable] = CBIG_MMP_ConvertSingleHemiSurfaceDataToDiscretizedAnnotation(data, ...
    discretization_res, colorscale, min_thresh, max_thresh, cutoff)  

% [labels, colortable] = CBIG_MMP_ConvertSingleHemiSurfaceDataToDiscretizedAnnotation(data, ..
%   discretization_res, colorscale, min_thresh, max_thresh, cutoff)  
%
% Adapted from CBIG_TRBPC_ConvertSingleHemiSurfaceDataToDiscretizedAnnotation.
%
