function CBIG_MM_KRR_classical_split_subject(data_dir, subject_list_file, rng_num, k, y, pre_fix)

% CBIG_MM_KRR_classical_split_subject(data_dir, subject_list_file, rng_num, k, y, pre_fix)
% 
