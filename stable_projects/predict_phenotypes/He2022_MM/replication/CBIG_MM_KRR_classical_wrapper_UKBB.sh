...
ks=(10 20 50 100 200)
split="test"
final_phe_list="${input_dir}/ukbb_${split}_final_phe_list.txt"
phe_csv="${input_dir}/ukbb_${split}_final.csv"
subj_list="${input_dir}/ukbb_${split}_subj_list.txt"
fc_mat="${input_dir}/ukbb_${split}_pfc.mat"
output="${rep_dir}/output_KRR_classical_ukbb"
