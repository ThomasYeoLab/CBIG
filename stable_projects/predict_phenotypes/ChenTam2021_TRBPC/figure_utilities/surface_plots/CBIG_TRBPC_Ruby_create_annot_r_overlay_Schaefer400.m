function CBIG_TRBPC_Ruby_create_annot_r_overlay_Schaefer400(input_vec, out_dir, lims, cmap)
...
% to do: will fix this and remove dependency on Ruby's code
addpath('/home/rkong/storage/ruby/data/Individual_areal_HCP/code/FCmap');
%load Alex parcellation
load('/home/rkong/storage/ruby/data/Individual_areal_HCP/split_data/figures/alex400/Alex400_fslr164.mat');
...
[lh_convert_labels, lh_colortable] = Ruby_ConvertSingleHemiSurfaceDataToDiscretizedAnnotation(lh_data,...
    140, colorscale, min_th, max_th);
[rh_convert_labels, rh_colortable] = Ruby_ConvertSingleHemiSurfaceDataToDiscretizedAnnotation(rh_data,...
    140, colorscale, min_th, max_th);
...
% to do: will fix this and remove dependency on Ruby's code
rmpath('/home/rkong/storage/ruby/data/Individual_areal_HCP/code/FCmap');
