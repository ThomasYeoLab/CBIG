function CBIG_ArealMSHBM_avg_profiles(seed_mesh,targ_mesh,out_dir,num_sub,num_sess)

% CBIG_ArealMSHBM_avg_profiles(seed_mesh,targ_mesh,out_dir,num_sub,num_sess)
...
%   - targ_mesh:
%
%     The surface space of fMRI data, e.g. 'fsaverage6' or 'fs_LR_32k'.
...
%
% Example:
% CBIG_ArealMSHBM_avg_profiles('fsaverage3','fsaverage5','./test_output','30','4');
%
...
for sub = 1:str2num(num_sub)
    disp(['current subject:' num2str(sub)]);
    for sess = 1:str2num(num_sess)
        ...
        elseif(~isempty(strfind(targ_mesh,'fsaverage'))) 
            ...
            error(['Unknown mesh type.'...
             'Only fsaverage surface types, for example, fsaverage5/6 and fs_LR_32k will be allowed.']);
        end
    end
end
