...
export CBIG_ArealMSHBM_REP_HCP_DIR=/mnt/isilon/CSC1/Yeolab/Data/HCP
...
export TMPDIR=/mnt/isilon/CSC2/Yeolab/Data/ABCD/process/y0/individual_parcellation/temp_dir
