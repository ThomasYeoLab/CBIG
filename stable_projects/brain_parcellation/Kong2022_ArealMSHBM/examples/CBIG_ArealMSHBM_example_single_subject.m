function  CBIG_ArealMSHBM_example_single_subject(out_dir)

% CBIG_ArealMSHBM_example_single_subject(out_dir)
%
% This function will call a simplified wrapper to run a single subject parcellation using gMSHBM. This example use
