...
sub${sub}/sess${sess}/lh.sub${sub}_sess${sess}_fsaverage6_roifsaverage3.surf2surf_profile_${split}.nii.gz"
			echo $lh_profile >> $out_dir/generate_individual_parcellations/profile_list/validation_set/lh_sess${new_sess}.txt;
...
sub${sub}/sess${sess}/rh.sub${sub}_sess${sess}_fsaverage6_roifsaverage3.surf2surf_profile_${split}.nii.gz"
			echo $rh_profile >> $out_dir/generate_individual_parcellations/profile_list/validation_set/rh_sess${new_sess}.txt;
