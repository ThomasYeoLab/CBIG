function mismatched_parcels = CBIG_hMRF_find_parcels_mismatched_topology_fs6_indirect_nbors(lh_full_label,...
     rh_full_label, threshold, expansion_steps, mesh_type)
% mismatched_parcels = CBIG_hMRF_find_parcels_mismatched_topology_fs6_indirect_nbors(lh_full_label,...
% rh_full_label, threshold, expansion_steps, mesh_type)
% 
...
%
% Example
%   - mismatched_parcels = CBIG_hMRF_find_parcels_mismatched_topology_fs6_indirect_nbors(lh_full_label, rh_full_label)
%
