...
set output_dir = $1
set sub_list = "$CBIG_CODE_DIR/stable_projects/brain_parcellation/Yeo2011_fcMRI_clustering"
set sub_list = "${sub_list}/examples/scripts/example_sub_list.txt"
...
${code_dir}/CBIG_Yeo2011_general_cluster_fcMRI_surf2surf_profiles.csh -sd ${output_dir}/subjects -sub_ls ${sub_list} \
    -surf_stem ${surf_stem} -n 17 -out_dir ${output_dir}/clustering \
    -cluster_out ${output_dir}/clustering/HNU_example_clusters017_scrub -tries 5 -outlier_stem ${outlier_stem}
