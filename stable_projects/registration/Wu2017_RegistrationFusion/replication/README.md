This README includes the instruction on how to run the replication tests for Wu2017_RegistrationFusion. Notice that all filenames and directories in this replication test **work for CBIG lab only**
