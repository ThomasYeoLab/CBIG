function CBIG_ComputeFullVol2SurfCorrelation(output_file, lh_varargin_text, rh_varargin_text, vol_varargin_text, mask_file, regress_bool, pval)
    ...
    for j = 1:length(C1)
        ...
        if(regress_bool > 0)
            ...
            if(regress_bool == 1  || regress_bool == 2)
                ...
                error('No other regression type for now');
            end
        end
