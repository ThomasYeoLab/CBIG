function CBIG_ComputeDistantDegree(input_file, output_file, neighbors_file, threshold)

% CBIG_ComputeDistantDegree(input_file, output_file, neighbors_file, threshold)
% This function is used to compute the distant degree with threshold for 
% each vertex.
% Input:
%      -input_file:
...
for i = 1:num_vertices
    index = ones(1, num_vertices);
    index(neighborhood_cell{i}) = 0;
    t_series = fmri(:, logical(index));
