function CBIG_KRR_workflow_LITE( setup_file, save_setup, varargin )

% CBIG_KRR_workflow_LITE( setup_file, save_setup, varargin )
% 
...
%     in cell arrays. In the case of "CBIG_KRR_workflow_LITE.m", since
...
CBIG_KRR_generate_kernels_LITE( param.feature_mat, param.outdir, param.ker_param )
