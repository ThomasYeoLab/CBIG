function CBIG_KRR_workflow( setup_param, save_setup, sub_fold_file, y_file, ...
    covariate_file, feature_file, num_inner_folds, outdir, outstem, varargin )

% CBIG_KRR_workflow( setup_param, save_setup, sub_fold_file, y_file, ...
%    covariate_file, feature_file, num_inner_folds, outdir, outstem, varargin )
% 
...
% hyperparameters can be passed in through the setup_param. Alternatively,
...
%
% CBIG_KRR_workflow( '', 1, sub_fold_file, y_file, ...
