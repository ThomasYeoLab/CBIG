...
for hemi in {L,R}; do
	...
	curr_sphere=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fsaverage_std_sphere.$hemi.164k_fsavg_$hemi.surf.gii
	new_sphere=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR-deformed_to-fsaverage.$hemi.sphere.164k_fs_LR.surf.gii		
	data_out=/$project_dir/${data_type}_$hemi.fs_LR_164k.$out_extension
	curr_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fsaverage.$hemi.midthickness_va_avg.164k_fsavg_$hemi.shape.gii
	new_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR.$hemi.midthickness_va_avg.164k_fs_LR.shape.gii
	...
	orig_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR.$hemi.midthickness_va_avg.164k_fs_LR.shape.gii
	downsample_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR.$hemi.midthickness_va_avg.32k_fs_LR.shape.gii
