...
for hemi in {L,R}; do
	...
	if [ "$fsLR_mesh" == "fs_LR_32k" ]; then
		...
		orig_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR.$hemi.midthickness_va_avg.32k_fs_LR.shape.gii
		upsample_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR.$hemi.midthickness_va_avg.164k_fs_LR.shape.gii
	...
	curr_sphere=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR-deformed_to-fsaverage.$hemi.sphere.164k_fs_LR.surf.gii		
	new_sphere=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fsaverage_std_sphere.$hemi.164k_fsavg_$hemi.surf.gii

	data_out=$project_dir/${data_type}_${hemi}_gifti.gii
	curr_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fs_LR.$hemi.midthickness_va_avg.164k_fs_LR.shape.gii
	new_area=$fsLR_surface_dir/standard_mesh_atlases/resample_fsaverage/fsaverage.$hemi.midthickness_va_avg.164k_fsavg_$hemi.shape.gii
