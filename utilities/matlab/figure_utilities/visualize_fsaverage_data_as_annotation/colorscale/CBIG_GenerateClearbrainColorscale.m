function colorscale = CBIG_GenerateClearbrainColorscale(res, min_val, max_val, output_dir)
  ...
  %
  % Produce a discretized colorscale based on Human Connectome Workbench's clear_brain color scheme
  %
  % Input:
  ...
  % Output:
  %   - colorscale: colorscale in Matlab's format with res number of values discretized from the clear_brain color scheme 
  %
