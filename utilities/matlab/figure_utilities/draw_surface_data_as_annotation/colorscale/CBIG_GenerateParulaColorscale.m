function colorscale = CBIG_GenerateParulaColorscale(res, min_val, max_val, output_dir)

% colorscale = CBIG_GenerateParulaColorscale(res, min_val, max_val, output_dir)
%
% Produce a discretized colorscale based on Matlab's parula colorscale
%
% Input:
...
% Output:
%   - colorscale: colorscale in Matlab's format with res number of values discretized from the parula color scheme
%
% colorscale = CBIG_GenerateParulaColorscale(28, 5e-5, 1, ...
%   '/Work/data/colorscale')
%   Generate a discrete colorscale of 28 bins with the value ranging from
%   5e-5 to 1. The colors come from the Matlab's parula color pallete
%
% Written by Gia H. Ngo and CBIG under MIT license: https://github.com/ThomasYeoLab/CBIG/blob/master/LICENSE.md

    colorscale = colormap(parula(res));
