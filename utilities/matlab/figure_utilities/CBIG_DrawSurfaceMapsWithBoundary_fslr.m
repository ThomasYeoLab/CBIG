function CBIG_DrawSurfaceMapsWithBoundary_fslr(lh_data, rh_data, ...
    lh_labels, rh_labels, mesh_name, surf_type, min_thresh, max_thresh, colors)

% CBIG_DrawSurfaceMapsWithBoundary(lh_data, rh_data, ...
%     lh_labels, rh_labels, mesh_name, surf_type, min_thresh, max_thresh, colors)
%
% This function visualizes lh_data and rh_data in fslr space with boundary defined 
% by a parcellation lh_labels, rh_labels in fslr space. Threshold can be 
% defined by min_thresh and max_thresh.
%
% Input:
%      -lh_data, rh_data: 
...
%
% Example:
% CBIG_DrawSurfaceMapsWithBoundary_fslr(lh_data, rh_data, lh_label,rh_label, 'fs_LR_32k', ...
% 'inflated', 0,400,rand(401,3));
%
