function surface_normals = CBIG_yeo_ComputeNormalVectorsCaret(mesh, avg_neighbor_bool)

% surface_normals = CBIG_yeo_ComputeNormalVectorsCaret(mesh, avg_neighbor_bool)
